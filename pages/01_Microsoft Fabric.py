...
widget_urls = [
    ...
    {"name": "Copilot for Power BI in Microsoft Fabric 2 (Presenter mode) English/Italian version",
    ...
    {"name": "Copilot for Power BI in Microsoft Fabric Manufacturing DREAM Demo (backend only)",
    ...
    {"name": "Copilot for Power BI in Microsoft Fabric Manufacturing DREAM Demo",
    ...
    {"name": "Copilot for Power BI in Microsoft Fabric Manufacturing DREAM Demo (backend only) Copilot",
